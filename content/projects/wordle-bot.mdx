---
title: Wordle Bot
description: A high-performance Wordle CLI with included solver. Analyze letter frequencies, simulate weighted strategies, and optimize the solver with a customizable heuristic engine.
repoLink: wordle-bot
techStack: Rust
