...
The lib.rs file is the connection point between the Next.js frontend and Rust backend. This file exposes commands to the frontend which fetch the data gathered by the ResourceMonitor.
...
This component generates a line graph on the fly to represent some historical data about the usages from each monitor. This line graph is an SVG image which gets displayed below the other component data.
