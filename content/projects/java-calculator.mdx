---
title: Calculator
description: A semi-advanced calculator built with JavaFX and CSS, featuring custom calculation logic.
intro: This is a semi-advanced calculator written in Java and CSS for styling using the JavaFX GUI library.
