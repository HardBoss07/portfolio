...
export const personalProjects: ProjectCardProps[] = [
  {
    title: "Cord Path",
    description:
      "This is a CLI tool that finds the optimal path over a set of 2D coordinates.",
    lang: ["Rust", "CUDA C++"],
    link: "cord-path",
  },
  {
    ...
    description:
      "This is a desktop app to monitor your PC's resources made with Tauri and Next.",
  ...
  },
  {
    title: "Snake",
    description:
      "This is a small project, where I remade the iconic game Snake completely in Rust using a minimal GUI library.",
    lang: "Rust",
    link: "rust-snake",
  },
  {
    ...
    description:
      "In this project I created a simple 1D and 2D barcode generator and reader. I made it as a web app using the NextJS framework.",
    lang: "TypeScript",
    link: "ts-barcode",
  },
  {
    title: "Tic Tac Toe",
    description:
      "In this project, I played around a little with Assembly. My goal was to make the fairly simple game Tic Tac Toe completely written in Assembly.",
    lang: "Assembly",
